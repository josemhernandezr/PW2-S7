  ...
  return (
    <li className={myClass}>
      <div className="flex px-3 sm:px-5 py-3 border-b-2 border-gray-100 w-full">
        <div className="flex w-4/6 sm:w-11/12">
